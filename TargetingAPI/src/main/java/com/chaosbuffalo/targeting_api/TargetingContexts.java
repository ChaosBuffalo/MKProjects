...
public class TargetingContexts {
     ...
     */
    public static final TargetingContext ALL = TargetingContext.Builder.create(LivingEntity.class)
     ...
     */
    public static final TargetingContext ALL_AROUND = TargetingContext.Builder.from(ALL)
     ...
     */
    public static final TargetingContext PLAYERS = TargetingContext.Builder.create(Player.class)
            .setTargetTest(Targeting::allowAny)
     ...
     */
    public static final TargetingContext PLAYERS_AROUND = TargetingContext.Builder.from(PLAYERS)
     ...
     * Only the caster.
     */
    public static final TargetingContext SELF = TargetingContext.Builder.create(LivingEntity.class)
     ...
     */
    public static final TargetingContext FRIENDLY = TargetingContext.Builder.create(LivingEntity.class)
     ...
     */
    public static final TargetingContext FRIENDLY_AROUND = TargetingContext.Builder.from(FRIENDLY)
     ...
     */
    public static final TargetingContext ENEMY = TargetingContext.Builder.create(LivingEntity.class)
            .canTargetCaster(false)
     ...
     */
    public static final TargetingContext NEUTRAL = TargetingContext.Builder.create(LivingEntity.class)
            .canTargetCaster(false)
