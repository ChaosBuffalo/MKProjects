...
public class LocationProviderTypes {
    ...
    public static final Supplier<LocationProviderType<SingleLocationProvider>> SINGLE_LOCATION = REGISTRY.register("single_location", () -> () -> SingleLocationProvider.CODEC);
