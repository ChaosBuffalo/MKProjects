...
class CoreLanguageProvider extends MKLanguageProvider {
    ...
    private void addGui() {
        ...
        add("mkcore.gui.character.learn_slot.current", "Slotted in %s %s");
        add("mkcore.gui.character.learn_slot.auto", "Will slot into %s %s");
        add("mkcore.gui.character.learn_slot.manual", "Will need a free %s slot");
        add("mkcore.gui.character.learn_slot.pool_full", "Requires %s free memory slots");
        ...
        add("mkcore.ability.group.basic", "Basic");
        add("mkcore.ability.group.passive", "Passive");
        add("mkcore.ability.group.ultimate", "Ultimate");
        add("mkcore.ability.group.item", "Item");
        ...
        add("mkcore.ability.feedback.learn_pool_full", "You need %s free memory slots to learn %s");
