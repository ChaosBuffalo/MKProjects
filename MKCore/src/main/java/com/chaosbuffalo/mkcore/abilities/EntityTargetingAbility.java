...
public abstract class EntityTargetingAbility extends MKAbility {
    ...
    public abstract void castAtEntity(IMKEntityData casterData, LivingEntity target, AbilityContext context);
    ...
    protected void onCastEnd(LivingEntity castingEntity, IMKEntityData casterData, AbilityContext context) {
        context.getMemory(MKAbilityMemories.ABILITY_TARGET).ifPresent(x -> castAtEntity(casterData, x, context));
    }
