...
public class EntityCastPacket {
    ...
    public static EntityCastPacket start(IMKEntityData entityData, MKAbilityInfo abilityInfo, int castTicks) {
        return new EntityCastPacket(entityData, abilityInfo, castTicks);
    }
