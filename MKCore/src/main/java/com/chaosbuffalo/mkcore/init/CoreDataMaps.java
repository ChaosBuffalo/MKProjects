...
public class CoreDataMaps {
    ...
    public static final DataMapType<Item, ItemBlockStats> ITEM_BLOCK_STATS = AdvancedDataMapType.builder(
                    MKCore.id("item_block_stats"),
                    Registries.ITEM,
                    ItemBlockStats.CODEC)
            .build();
    ...
    private static void registerDataMapTypes(RegisterDataMapTypesEvent event) {
        ...
        event.register(ITEM_BLOCK_STATS);
    }
}
