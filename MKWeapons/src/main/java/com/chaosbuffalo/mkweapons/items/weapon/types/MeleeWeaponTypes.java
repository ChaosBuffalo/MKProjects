...
public class MeleeWeaponTypes {
    ...
    public static final MeleeWeaponType GREATSWORD_TYPE = MeleeWeaponType.builder(MKWeapons.id("greatsword"))
            ...
            .isTwoHanded()
            .blocking(0.9f, 40)
            .effect(new MeleeSkillScalingEffect(8.0, MKAttributes.TWO_HAND_SLASH))
    ...
    public static final MeleeWeaponType KATANA_TYPE = MeleeWeaponType.builder(MKWeapons.id("katana"))
            ...
            .isTwoHanded()
            .blocking(0.75f, 25f)
            .effect(new MeleeSkillScalingEffect(9.0, MKAttributes.TWO_HAND_SLASH))
    ...
    public static final MeleeWeaponType STAFF_TYPE = MeleeWeaponType.builder(MKWeapons.id("staff"))
            ...
            .isTwoHanded()
            .blocking(0.85f, 30f)
            .effect(new MeleeSkillScalingEffect(6.5, MKAttributes.TWO_HAND_BLUNT))
    ...
    public static final MeleeWeaponType WARHAMMER_TYPE = MeleeWeaponType.builder(MKWeapons.id("warhammer"))
            ...
            .isTwoHanded()
            .blocking(0.80f, 25f)
            .effect(new MeleeSkillScalingEffect(7.0, MKAttributes.TWO_HAND_BLUNT))
    ...
    public static final MeleeWeaponType BATTLEAXE_TYPE = MeleeWeaponType.builder(MKWeapons.id("battleaxe"))
            ...
            .isTwoHanded()
            .blocking(0.80f, 25f)
            .effect(new MeleeSkillScalingEffect(7.25, MKAttributes.TWO_HAND_SLASH))
            .effect(new BleedMeleeWeaponEffect(1.5f, 5, 4, MKAttributes.TWO_HAND_SLASH))
            .build();
