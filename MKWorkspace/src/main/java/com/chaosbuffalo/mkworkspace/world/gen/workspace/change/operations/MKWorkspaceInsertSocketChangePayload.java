...
public record MKWorkspaceInsertSocketChangePayload(
    ...
    public static final Codec<MKWorkspaceInsertSocketChangePayload> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.BOOL.fieldOf("createSlot").forGetter(MKWorkspaceInsertSocketChangePayload::createSlot),
                    Codec.STRING.fieldOf("slotId").forGetter(MKWorkspaceInsertSocketChangePayload::slotId),
