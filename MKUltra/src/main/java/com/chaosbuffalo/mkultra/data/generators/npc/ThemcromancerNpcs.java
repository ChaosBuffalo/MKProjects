...
public class ThemcromancerNpcs {
    ...
    static NpcDefinition generateThemnianArchon() {
        ...
        return new NpcDefinitionBuilder(MKUltra.id("themcromancer_archon"))
                ...
                .dropChance(0.05f)
                .notable()
                .loot(LootSlotManager.RINGS, MKUltra.id("themcromancer_archon"), 3.0)
                .loot(LootSlotManager.EARRINGS, MKUltra.id("themcromancer_archon"), 2.0)
                .dropChance(1)
                .noLootChance(0.25)
    ...
    static NpcDefinition generateThemnianLibrarian() {
        ...
        return new NpcDefinitionBuilder(MKUltra.id("themcromancer_librarian"))
                ...
                .notable()
                .loot(LootSlotManager.MAIN_HAND, MKUltra.id("themcromancer_librarian"), 3.0)
                .dropChance(1)
                .noLootChance(0.25)
                .noLootChanceIncrease(0.0)
                .ability(MKUAbilities.SHADOW_BOLT_DUAL_SHOTGUN, 1, 1.0)
