...
public class IntroCastleNpcs {
    ...
    static NpcDefinition generateCrumblingTrooper(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.ZOMBIFIED_PIGLIN_TYPE)
                ...
                .size(1.1f)
                .renderGroup(MKUPiglins.ZOMBIE_PIG_TROOPER_LOOK)
                .name("Crumbling Trooper")
                .health(50)
                .mana(50)
                .manaRegen(1.0)
                .lungeSpeed(0.35)
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.LONGSWORD_TYPE))
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.WARHAMMER_TYPE))
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.MACE_TYPE))
    ...
    static NpcDefinition generateSkeletalTrooperMage(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.ZOMBIFIED_PIGLIN_TYPE)
                .faction(MKUFactions.IMPERIAL_DEAD_NAME)
                .size(1.0f)
                .renderGroup(MKUPiglins.DESTROYED_SKELETAL_MAGE_LOOK)
                .health(50)
                .mana(50)
                .manaRegen(2.0)
                .name("Skeletal Magus")
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.DAGGER_TYPE))
    ...
    static NpcDefinition generateTrooperCaptain(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.ZOMBIFIED_PIGLIN_TYPE)
                .renderGroup(MKUPiglins.SKELETAL_TROOPER_LOOK)
                .faction(MKUFactions.IMPERIAL_DEAD_NAME)
                .size(1.2f)
                .combo(10, 3)
                .health(100)
                ...
                .lungeSpeed(1.0)
                .notable()
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.GREATSWORD_TYPE))
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.KATANA_TYPE))
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.WARHAMMER_TYPE))
    ...
    static NpcDefinition generateImperialMagus(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.ZOMBIFIED_PIGLIN_TYPE)
                .faction(MKUFactions.IMPERIAL_DEAD_NAME)
                .size(1.0f)
                .renderGroup(MKUPiglins.SKELETAL_MAGE_LOOK)
                .health(150)
                .mana(150)
                .manaRegen(3.0)
    ...
    static NpcDefinition generateCrumblingTrooperMage(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.ZOMBIFIED_PIGLIN_TYPE)
                .faction(MKUFactions.IMPERIAL_DEAD_NAME)
                .size(0.95f)
                .renderGroup(MKUPiglins.ZOMBIE_PIG_MAGUS_LOOK)
    ...
    static NpcDefinition generateDecayingZombieArcher(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.ZOMBIFIED_PIGLIN_TYPE)
                .faction(MKUFactions.IMPERIAL_DEAD_NAME)
                .size(0.85f)
                .renderGroup(MKUPiglins.ZOMBIE_PIG_LOOK)
                .health(15.0)
                .mana(15.0)
                .manaRegen(1.0)
    ...
    static NpcDefinition generateTrooperExecution(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.ZOMBIFIED_PIGLIN_TYPE)
                .faction(MKUFactions.IMPERIAL_DEAD_NAME)
                .size(1.0f)
                .renderGroup(MKUPiglins.DESTROYED_SKELETAL_TROOPER_LOOK)
                .combo(20, 3)
                .health(180.0)
                .mana(180.0)
                .manaRegen(2.0)
                ...
                .lungeSpeed(0.75)
                .notable()
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.STONE_TIER, MeleeWeaponTypes.BATTLEAXE_TYPE))
                .ability(MKUAbilities.FURIOUS_BROODING, 3, 1.0)
    ...
    static NpcDefinition generateClericApprentice(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.HUMAN_TYPE)
                ...
                .size(0.85f)
                .renderGroup(MKUHumans.CLERIC_2_LOOK)
                .health(100.0)
                .mana(100.0)
                .manaRegen(2.5)
                .titledFactionName("Apprentice", false)
                .notable()
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.IRON_TIER, MeleeWeaponTypes.MACE_TYPE))
                .ability(MKUAbilities.HEAL, 1, 1.0)
    ...
    static NpcDefinition generateNetherMageInitiate(ResourceKey<NpcDefinition> key, BootstrapContext<NpcDefinition> context) {
        ...
        return new NpcDefinitionBuilder(key, MKUEntities.HUMAN_TYPE)
                ...
                .size(0.90f)
                .renderGroup(MKUHumans.NETHER_MAGE_1_LOOK)
                .health(150.0)
                .mana(150.0)
                .manaRegen(3.0)
                .titledFactionName("Initiate", false)
                .notable()
                .mainHand(MKWeaponsItems.lookupWeapon(MKWeaponsItems.WOOD_TIER, MeleeWeaponTypes.STAFF_TYPE))
    ...
    static NpcDefinition generateBurningSkeleton(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.HYBOREAN_SKELETON_TYPE)
                ...
                .size(1.0f)
                .renderGroup(MKUSkeletons.BURNING_LOOK)
    ...
    static NpcDefinition generateForlornGhost(ResourceKey<NpcDefinition> key) {
        return new NpcDefinitionBuilder(key, MKUEntities.HUMAN_TYPE)
                .faction(MKUFactions.SEE_OF_SOLANG_NAME)
                .size(1.0f)
                .renderGroup(MKUHumans.GHOST_1_LOOK)
                .health(100.0)
                .mana(100.0)
                .manaRegen(3.0)
                .name("Forlorn Ghost")
