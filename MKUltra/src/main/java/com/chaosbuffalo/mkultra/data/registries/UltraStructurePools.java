...
public class UltraStructurePools {
    public static ResourceKey<StructureTemplatePool> createKey(String pName) {
        return ResourceKey.create(Registries.TEMPLATE_POOL, MKUltra.id(pName));
    }
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> pContext) {
        ...
        ThemcromancersLairPools.registerPools(pContext);
        FireShrinePools.registerPools(pContext);
    }
}
