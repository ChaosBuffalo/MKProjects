...
public class MKUAbilities {
    ...
    public static final RegistryObject<EngulfingDarknessAbility> ENGULFING_DARKNESS = REGISTRY.register("ability.engulfing_darkness", EngulfingDarknessAbility::new);
    ...
    public static final RegistryObject<FlameWaveAbility> FLAME_WAVE = REGISTRY.register("ability.flame_wave", FlameWaveAbility::new);
    public static final RegistryObject<IgniteAbility> IGNITE = REGISTRY.register("ability.ignite", IgniteAbility::new);
    public static final RegistryObject<WarpCurseAbility> WARP_CURSE = REGISTRY.register("ability.warp_curse", WarpCurseAbility::new);

    //green knight
    public static final RegistryObject<SpiritBombAbility> SPIRIT_BOMB = REGISTRY.register("ability.spirit_bomb", SpiritBombAbility::new);
    ...
    public static final RegistryObject<PowerWordSummonAbility> POWER_WORD_SUMMON = REGISTRY.register("ability.power_word_summon", PowerWordSummonAbility::new);
    public static final RegistryObject<InspireAbility> INSPIRE = REGISTRY.register("ability.inspire", InspireAbility::new);
    public static final RegistryObject<HealAbility> HEAL = REGISTRY.register("ability.heal", HealAbility::new);
    public static final RegistryObject<GalvanizeAbility> GALVANIZE = REGISTRY.register("ability.galvanize", GalvanizeAbility::new);

    //brawler
    public static final RegistryObject<YaupAbility> YAUP = REGISTRY.register("ability.yaup", YaupAbility::new);
    public static final RegistryObject<YankAbility> YANK = REGISTRY.register("ability.yank", YankAbility::new);
    public static final RegistryObject<WhirlwindBladesAbility> WHIRLWIND_BLADES = REGISTRY.register("ability.whirlwind_blades", WhirlwindBladesAbility::new);
    public static final RegistryObject<StunningShoutAbility> STUNNING_SHOUT = REGISTRY.register("ability.stunning_shout", StunningShoutAbility::new);
