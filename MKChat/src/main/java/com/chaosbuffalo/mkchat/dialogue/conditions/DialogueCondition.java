...
public abstract class DialogueCondition {
    public static final Codec<DialogueCondition> CODEC = Codec.lazyInitialized(ChatRegistries.DIALOGUE_CONDITIONS::byNameCodec)
            .dispatch(DialogueCondition::getType, DialogueConditionType::codec);
