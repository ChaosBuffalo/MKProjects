...
public abstract class DialogueEffect {
    public static final Codec<DialogueEffect> CODEC = Codec.lazyInitialized(ChatRegistries.DIALOGUE_EFFECTS::byNameCodec)
            .dispatch(DialogueEffect::getType, DialogueEffectType::codec);
