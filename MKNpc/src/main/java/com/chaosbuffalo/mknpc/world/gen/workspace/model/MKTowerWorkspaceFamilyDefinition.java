...
public class MKTowerWorkspaceFamilyDefinition implements MKWorkspacePaletteFamily {
    ...
    private static List<MKTowerWorkspaceFamilyDefinition> createKeepTowerStackDefaults(String basePrefix,
                                                                                       ...
                                                                                       int height) {
        return List.of(
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_entry", MKTowerWorkspaceCategory.ENTRY,
                        MKWorkspacePieceRole.ENTRY, stackId + ".entry", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null),
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_main_floor", MKTowerWorkspaceCategory.MAIN,
                        MKWorkspacePieceRole.FLOOR_MAIN, stackId + ".main_floor", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null),
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_top_cap_approach", MKTowerWorkspaceCategory.TOP_CAP,
                        MKWorkspacePieceRole.TOP_CAP_APPROACH, stackId + ".top_cap_approach", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null),
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_top_cap", MKTowerWorkspaceCategory.TOP_CAP,
                        MKWorkspacePieceRole.TOP_CAP, stackId + ".top_cap", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null),
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_basement_entry", MKTowerWorkspaceCategory.BASEMENT,
                        MKWorkspacePieceRole.BASEMENT_ENTRY, stackId + ".basement_entry", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null),
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_basement_floor", MKTowerWorkspaceCategory.BASEMENT,
                        MKWorkspacePieceRole.BASEMENT_MAIN, stackId + ".basement_floor", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null),
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_basement_cap_approach",
                        MKTowerWorkspaceCategory.BASEMENT_CAP, MKWorkspacePieceRole.BASEMENT_CAP_APPROACH,
                        stackId + ".basement_cap_approach", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null),
                new MKTowerWorkspaceFamilyDefinition(basePrefix + "_basement_cap",
                        MKTowerWorkspaceCategory.BASEMENT_CAP, MKWorkspacePieceRole.BASEMENT_CAP,
                        stackId + ".basement_cap", stackId, true,
                        width, length, height,
                        MKWorkspaceHorizontalExtrusionMode.NO_EXTRUSION, List.of(), 0, 0,
                        MKWorkspaceFoundationPolicy.none(), null)
        );
