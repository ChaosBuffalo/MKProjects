...
public class QuestRequirementTypes {
    ...
    public static final Supplier<QuestRequirementType<HasEntitlementRequirement>> HAS_ENTITLEMENT = REGISTRY.register("has_entitlement", () -> () -> HasEntitlementRequirement.MAP_CODEC);
}
